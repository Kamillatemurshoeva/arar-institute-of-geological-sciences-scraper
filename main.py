...
START_URL = "https://arar.sci.am/dlibra/results?q=&action=SimpleSearchAction&type=-6&p=0&qf1=collections:18"
LIST_URL = "https://arar.sci.am/dlibra/results?q=&action=SimpleSearchAction&type=-6&p={}&qf1=collections:18"
...
def parse_item(session, url):
    ...
    description = pick_field(fields, ["Description", "Abstract"])
...
def main():
    ...
    save_csv(records, "arar_collection_18.csv")

    save_jsonl(records, "arar_collection_18.jsonl")
